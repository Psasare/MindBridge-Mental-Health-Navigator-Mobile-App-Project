...
export const GoalService = {
     ...
     */
    generateDailyGoals: async (userId, primaryState) => {
     ...
     */
    completeGoal: async (userId, goalId, rating, timeSpent, stateBefore, stateAfter) => {
        // 1. Log completion
        ...
        if (newlyCompletedCount === 3)
            extraPoints = 20; // Bonus for hitting 3 goals
        if (newlyCompletedCount === 5)
            extraPoints = 50; // Bonus for 5 goals
