...
const createStyles = (theme: any) => StyleSheet.create({
  ...
  statsCard: { flex: 1, backgroundColor: theme.colors.surface, padding: 16, borderRadius: 24, borderWidth: 1, borderColor: theme.isDark ? 'rgba(255,255,255,0.05)' : 'rgba(0,0,0,0.02)', shadowColor: theme.isDark ? 'transparent' : '#000', shadowOffset: { width: 0, height: 4 }, shadowOpacity: theme.isDark ? 0 : 0.03, shadowRadius: 10, elevation: theme.isDark ? 0 : 2 },
  ...
  historyItem: { backgroundColor: theme.colors.surface, flexDirection: 'row', alignItems: 'center', padding: 18, borderRadius: 24, marginBottom: 14, borderWidth: 1, borderColor: theme.isDark ? 'rgba(255,255,255,0.05)' : 'rgba(0,0,0,0.02)', gap: 16, shadowColor: theme.isDark ? 'transparent' : '#000', shadowOffset: { width: 0, height: 2 }, shadowOpacity: theme.isDark ? 0 : 0.03, shadowRadius: 8, elevation: theme.isDark ? 0 : 1 },
  ...
  analysisCard: { backgroundColor: theme.colors.surface, borderRadius: 28, padding: 20, marginBottom: 20, borderWidth: 1, borderColor: theme.isDark ? 'rgba(255,255,255,0.05)' : 'rgba(0,0,0,0.02)', shadowColor: theme.isDark ? 'transparent' : '#000', shadowOffset: { width: 0, height: 4 }, shadowOpacity: theme.isDark ? 0 : 0.04, shadowRadius: 12, elevation: theme.isDark ? 0 : 3 },
